...
ENGINES runs ManifestRunner, writes results to data/output/
"""
...
from engines.runner import ManifestRunner
...
async def list_engines():
    ...
    from engines.python_runner import SIGNAL_ENGINES, PAIR_ENGINES, SYMMETRIC_PAIR_ENGINES, WINDOWED_ENGINES
    from engines.sql_runner import SQL_ENGINES

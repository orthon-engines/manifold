...
class StateVector:
    """
    System-scoped indicator state vector.

    This object describes the position of a single indicator
    ...
    Key invariant: Indicators do not belong to systems. Indicator records do.
    A state vector cannot exist without a system_record_id.

    Attributes:
        system_record_id: The system run this state belongs to (required)
        indicator_name: The indicator this state describes
